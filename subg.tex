...
\only<9>{Proposal \color{col1} $\ q(T)$}%
...
%$P^{\textsc{Combo}} = \alpha P^{\textsc{Gibbs}} + (1 - \alpha) P^{\mathrm{M}^3}$
\vspace{0.7em}
$\rightarrow\ \ $ Gibbs step with probability $\alpha$ \hspace{1em}|\hspace{1em} $\mathrm{M}^3$ step with prob. $1 - \alpha$
